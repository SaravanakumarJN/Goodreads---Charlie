...
export const getData = (payload) => (dispatch) => {
  dispatch(PostReq());
  axios
    .post("https://good-reads-users-mock.herokuapp.com/community_updates", {
      name: payload.name,
    ...
    .then((res) => {
      axios
        .get(
          `https://good-reads-users-mock.herokuapp.com/community_updates/q=${payload.name}`
        )
        .then((res) => {
